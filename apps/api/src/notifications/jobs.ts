 ...
 * piece of work), sends the ones that were made to Telegram for whoever linked a chat, and removes notifications
 * older than 90 days. Nothing is sent by email.
 */
